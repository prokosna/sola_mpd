...
import { CommonSongTableStateRepository } from "../../features/song_table";
import { HttpClient } from "../http/HttpClient";

export class CommonSongTableStateRepositoryHttp
  implements CommonSongTableStateRepository
{
