...
// column widths without touching sort, the server-side column set, or any
// other device setting. A no-op while the migration is pending, since the
// underlying atom refuses writes until it resolves.
