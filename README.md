...
[Sola MPD](https://prokosna.github.io/sola_mpd/) is an MPD client focused on usability with flexible browsing and search. It runs as a web application (Docker) or a desktop application (Experimental: supporting Windows, macOS and Linux).
